...
수동 가능 항목 (Task 4.5/4.6, 사용자 직접):

- TestPyPI 업로드 + `pipx install --index-url https://test.pypi.org/simple/ assetcache-mcp` 결과 (시나리오 7)
- 정식 PyPI 업로드 후 `pipx install assetcache-mcp` 결과 (시나리오 7)
