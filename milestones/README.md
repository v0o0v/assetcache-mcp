...
| [M3 — 검색 백엔드 + 통일성 + MCP](./M3_plan.md) | ✅ 완료 | 110/110 (전체 331/331, `clip_integration` 2 + `mcp_integration` 2 옵트인 제외) | 수동 시나리오는 `M3_verification.md` §4 (GUI 검색 박스 1 항목) | HybridSearcher 가중합 0.40/0.15/0.20/0.20/0.05·ConsistencyScorer §4.6 표·UsageTracker·MCP stdio 12 도구 (mcp 1.27)·GUI 검색 박스·`docs/MCP_USAGE_GUIDE.md` 본격화 |
