...
| `tests/test_locale_assetcache_msgid.py` | `NEW_MSGIDS` 의 마이그레이션 3건 제거. parametrize 10 → 4 case |
...
| 파일 | 후기 |
|---|---|
| `milestones/M10_plan.md` | "Phase 1 데이터 폴더 마이그레이션 helper 는 v0.1.1 (2026-05-20) 에서 yagni-clean — v0.0.1 외부 사용자 0 확인 후" |
